...
class WebUIApi:
    ...
    def txt2img(
        ...
        if (
            ...
            and controlnet_units
            and len(controlnet_units) > 0
        ):
            payload["controlnet_units"] = [
                x.to_dict() for x in controlnet_units
            ]
...
class ControlNetInterface:
    ...
    def txt2img(
        ...
        controlnet_input_image_b64 = [
            raw_b64_img(x) for x in controlnet_input_image
        ]
